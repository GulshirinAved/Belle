...
class MasterChooseDateScreen extends StatefulWidget {
  // final ClientMasterInfoDto? masterInfo;
  final ChosenMasterServicesToSendDto? chosenServicesToSendDto;

  const MasterChooseDateScreen({
    super.key,
  ...
  @override
  State<MasterChooseDateScreen> createState() => _MasterChooseDateScreenState();
}

class _MasterChooseDateScreenState extends State<MasterChooseDateScreen> {
  final controller = GetIt.instance<MasterChosenServicesController>();
  final stateController = GetIt.instance<MasterChosenServicesStateController>();
  final calendarController =
      GetIt.instance<MasterChosenServicesCalendarController>();
  ...
  void getDataAndInit() {
    controller.postChosenServices(widget.chosenServicesToSendDto, (value) {
      ...
      stateController.initChosenServices(widget.chosenServicesToSendDto);
