...
part 'client_master_services_controller.g.dart';

class ClientMasterServicesController
...
class ClientMasterServicesStateController = _ClientMasterServicesStateControllerBase
    with _$ClientMasterServicesStateController;

abstract class _ClientMasterServicesStateControllerBase with Store {
  @observable
